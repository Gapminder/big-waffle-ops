...
2. The command gets interpreted by [the BigWaffle slack app](https://api.slack.com/apps/AH2RL6423), which Angie, Fredrik and dev@gapminder.org have access to and can add others as Collaborators. Note you need to look in Slack apps --> Build --> Your apps, not in the installed apps of the gapminder workspace.
